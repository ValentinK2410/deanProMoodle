...
$string['feedtype_nostudent'] = 'No student role';
$string['feedkind_registration'] = 'New accounts';
$string['feedkind_nostudent'] = 'No role';
...
$string['feed_help'] = 'Sub-tabs for the last 90 days: «New accounts» — new account with Student role (MBS portal); «No role» — registered but no Student role yet; «Course enrolment» — individual enrolment; «Global groups» — mass cohort enrolment. Column «Form»: green check — required Additional data fields. Hiding only removes the row; restore from the Hidden tab.';
$string['feedempty_registration'] = 'No new accounts in the last 90 days, or all are hidden.';
$string['feedempty_nostudent'] = 'No new accounts without Student role in the last 90 days, or all are hidden.';
