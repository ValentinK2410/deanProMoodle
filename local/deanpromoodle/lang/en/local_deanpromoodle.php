...
$string['identitydocs_hint'] = 'Allowed: JPG, PNG, PDF up to 5 MB per file. Only you, site administrators, and authorised staff can view the files.';
$string['identitydocs_storage_note'] = 'Files are not stored in a public server folder or standard course files area. After you save, they are kept in Moodle\'s protected file storage linked to your user account. Check the «Uploaded» label and preview below; use «Open file» to download (including PDFs).';
