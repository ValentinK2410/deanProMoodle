...
// лента: в колонках программа/курс — по одному значению (первая программа по когорте, последнее зачисление на курс).
$plugin->version = 2026021306; // Исправление отображения сканов паспорта (get_area_files); PRG после сохранения.
