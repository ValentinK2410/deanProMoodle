...
// Версия ниже совпадает с последним savepoint в db/upgrade.php (после него нет шагов xmldb).
// Код новее (кнопка «Скачать», правка «Пол») сохраняется; логические метки ниже только в комментариях:
// 2026051102 — скачать identitydocs; 2026051103 — selected в списке пола.
