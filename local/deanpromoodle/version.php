 ...
 * эту страницу проверки ядра: это не параметр локального плагина. Решение — привести СУБД к требуемой
 * версии или использовать сборку Moodle, официально совместимую с вашей версией MySQL/MariaDB.
 *
