...
cd /var/www/www-root/data/www/class.mbs.ru/local
...
sudo rm -rf /var/www/www-root/data/www/class.mbs.ru/moodledata/cache/*
```
...
mv ~/.local/share/Trash/files/deanpromoodle /var/www/www-root/data/www/class.mbs.ru/local/
```
...
cp -r /path/to/backup/deanpromoodle /var/www/www-root/data/www/class.mbs.ru/local/

# Установите права доступа
sudo chown -R www-data:www-data /var/www/www-root/data/www/class.mbs.ru/local/deanpromoodle
sudo chmod -R 755 /var/www/www-root/data/www/class.mbs.ru/local/deanpromoodle
```

## Способ 5: Восстановление через Git (если каталог был Git репозиторием)

Если каталог `/var/www/www-root/data/www/class.mbs.ru/local/deanpromoodle` был Git репозиторием:
