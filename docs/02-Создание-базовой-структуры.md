...
$plugin->requires = 2022041900; // Moodle 4.0 или выше
...
$capabilities = [
    'local/deanpromoodle:viewstudent' => [
        ...
        'archetypes' => [
            'student' => CAP_ALLOW,
            'user' => CAP_ALLOW, // Разрешить всем авторизованным пользователям (резервный вариант)
        ],
    ],
...
function local_deanpromoodle_extend_navigation(global_navigation $navigation) {
    ...
    // Получение главного узла навигации
    ...
    // Добавление страницы студента, если у пользователя есть права
